...
try:
    ...
    # Never block bot startup because file logging failed.
    FALLBACK_CONFIG = dict(LOGGING_CONFIG)
    FALLBACK_CONFIG["handlers"] = {"console": LOGGING_CONFIG["handlers"]["console"]}
    for logger_name, logger_conf in FALLBACK_CONFIG["loggers"].items():
